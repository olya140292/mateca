...
const WORDS = [
  ['Голос',.27,.22,0],['Речь',.16,.29,760],['Смысл',.08,.39,1080],['Подача',.09,.58,760],['Диалог',.18,.48,1080],
  ['Подход',.20,.76,0],['Переговоры',.34,.88,900],['Выступления',.50,.87,0],['Самопрезентация',.65,.90,760],['Границы',.77,.80,1080],
...
const LINKS = {
  ...
  Переговоры:['Границы','Репутация'], Выступления:['Самопрезентация'], Самопрезентация:['Проявленность','Возможности'],
